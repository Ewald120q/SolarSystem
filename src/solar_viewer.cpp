...
void Solar_viewer::render()
{
    ...
    mat4 camera_distance = mat4(0);
    camera_distance = camera_distance.translate(vec3(0,0,radius*dist_factor_));

    eye = camera_distance*vec4(0,0,0,1);
    eye = center+camera_rotation_*eye;

    up = camera_rotation_ * up;
